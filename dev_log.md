...
- 未(P2残): 領域研究の罠5種(毒沼/炎/氷/電気/針)、縦の4/5層拡張ノードの効果配線(準備中の階層追加ゲート)、錬成研究(宝箱手動配置)、魔王研究(反撃/回復)。
- 次: P2残(罠種類/縦拡張ゲート/宝箱手動配置) → P3 特殊制限(ショップ/レアリティ/スロット)。
- 未: (大)眷属化→地上4X / 見た目③SPUMキャラ(fable5推奨)。
